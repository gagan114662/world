...
import { Moon, Sun, User, Settings, LogOut, Beaker } from "lucide-react";
...
interface HeaderProps {
    ...
    onToggleExplainToLearn: () => void;
}

export default function Header({ sidebarOpen, onToggleSidebar, onToggleExplainToLearn }: HeaderProps) {
        ...
        <header className="fixed top-0 left-0 right-0 h-[44px] lg:h-[48px] bg-[#FFFDF5] dark:bg-[#000000] border-b-[3px] lg:border-b-[4px] border-black dark:border-white z-40 flex items-center justify-between px-2 md:px-4 lg:px-5 shadow-[0_2px_0_0_rgba(0,0,0,1)] lg:shadow-[0_2px_0_0_rgba(0,0,0,1)] dark:shadow-[0_2px_0_0_rgba(255,255,255,0.3)]">
            ...
            <div className="flex items-center gap-1.5 md:gap-2">
                ...
                <Button
                    ...
                    variant="ghost"
                    size="icon"
                    title="Explain to Learn (Lab)"
                    className="w-7 h-7 md:w-8 md:h-8 lg:w-8 lg:h-8 border-[2px] border-black dark:border-white bg-[#C4B5FD] hover:bg-[#B794F4] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none shadow-[1px_1px_0_0_rgba(0,0,0,1)] lg:shadow-[1px_1px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] transition-all duration-100 text-black"
                    onClick={onToggleExplainToLearn}
                >
                    <Beaker className="h-[0.9rem] w-[0.9rem] md:h-[1rem] md:w-[1rem]" />
                </Button>
